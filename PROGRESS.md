...
tests/test_sql_executor.py [XONG] Giai đoạn 8 — 13 test cho _is_select_only/_is_single_statement, 13/13 pass, gồm test khoá lại giới hạn CTE-ghi-dữ-liệu và 2 test chống nới lỏng nhầm (EXPLAIN ANALYZE, CALL)
